...
from ui_layout import get_shop_item_rects, get_shop_back_rect, ui
...
def draw_shop():
    ...
    item_rects = get_shop_item_rects(WIDTH, UI_SCALE)
    ...
    back_rect = get_shop_back_rect(WIDTH, UI_SCALE)
